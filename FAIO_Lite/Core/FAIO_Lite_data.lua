...
FAIO_Lite_data.dodgeItItems = { 
	{"item_manta", 1, "no target", 0.1}, 
	{"item_blink", 0, "position", 0.2}, 
	{"item_cyclone", 0, "target", 0.2},
	{"item_lotus_orb", 1, "target", 0.2},
	{"item_black_king_bar", 2, "no target", 0.2},
	{"item_blade_mail", 0, "no target", 0.2},
	{"item_glimmer_cape", 0, "target", 0.2}
		}

FAIO_Lite_data.dodgeItSkills = {
	{"storm_spirit_ball_lightning", 0, "position", 0.5},
...
FAIO_Lite_data.preemptiveBKBtable = {
...
FAIO_Lite_data.dodgeEnemySkillsTable = {
	"antimage_mana_void",
	"alchemist_unstable_concoction_throw",
	"axe_berserkers_call",
	"bane_fiends_grip",
...
FAIO_Lite_data.JunglePositionTable = {
...
FAIO_Lite_data.invokerInvokeOrder = {
...
FAIO_Lite_data.invokerTornadoLiftDuration = { 0.8, 1.1, 1.4, 1.7, 2.0, 2.3, 2.6, 2.9 }
...
FAIO_Lite_data.armletDotTickTable = {
...
FAIO_Lite_data.armletDotTickTableAOE = {
...
FAIO_Lite_data.RawDamageAbilityEstimation = {
...
FAIO_Lite_data.NeutralListComplete = {
...
FAIO_Lite_data.NeutralMainNPCsmall = {
	"npc_dota_neutral_kobold_taskmaster",
	"npc_dota_neutral_forest_troll_berserker",
	"npc_dota_neutral_gnoll_assassin",
	"npc_dota_neutral_ghost",
...
FAIO_Lite_data.NeutralMainNPCmedium = {
	"npc_dota_neutral_centaur_khan",
	"npc_dota_neutral_alpha_wolf",
	"npc_dota_neutral_satyr_soulstealer",
	"npc_dota_neutral_ogre_mauler",
...
FAIO_Lite_data.NeutralMainNPChard = {
	"npc_dota_neutral_centaur_khan",
	"npc_dota_neutral_satyr_hellcaller",
	"npc_dota_neutral_polar_furbolg_ursa_warrior",
	"npc_dota_neutral_enraged_wildkin",
...
FAIO_Lite_data.neutralsAbilityListDebuff = {	
...
FAIO_Lite_data.neutralsAbilityListBuff = {
